...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface GodsTokenInterface extends Interface {
    getFunction(nameOrSignature: "DEFAULT_ADMIN_ROLE" | "DOMAIN_SEPARATOR" | "MAX_SUPPLY" | "MINTER_ROLE" | "allowance" | "approve" | "balanceOf" | "burn" | "burnFrom" | "decimals" | "eip712Domain" | "getRoleAdmin" | "grantRole" | "hasRole" | "mint" | "name" | "nonces" | "permit" | "remainingSupply" | "renounceRole" | "revokeRole" | "supportsInterface" | "symbol" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "Approval" | "Disbursed" | "EIP712DomainChanged" | "RoleAdminChanged" | "RoleGranted" | "RoleRevoked" | "Transfer"): EventFragment;
...
decodeFunctionResult(functionFragment: 'transferFrom', data: BytesLike): Result;
    ...
    export namespace DisbursedEvent {
      export type InputTuple = [recipient: AddressLike, amount: BigNumberish, reason: string];
      export type OutputTuple = [recipient: string, amount: bigint, reason: string];
      export interface OutputObject {recipient: string, amount: bigint, reason: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  export interface GodsToken extends BaseContract {
    
    connect(runner?: ContractRunner | null): GodsToken;
    waitForDeployment(): Promise<this>;

    interface: GodsTokenInterface;
...
getEvent(key: 'Disbursed'): TypedContractEvent<DisbursedEvent.InputTuple, DisbursedEvent.OutputTuple, DisbursedEvent.OutputObject>;
...
getEvent(key: 'Transfer'): TypedContractEvent<TransferEvent.InputTuple, TransferEvent.OutputTuple, TransferEvent.OutputObject>;
    ...
    filters: {
      ...
      'Disbursed(address,uint256,string)': TypedContractEvent<DisbursedEvent.InputTuple, DisbursedEvent.OutputTuple, DisbursedEvent.OutputObject>;
      Disbursed: TypedContractEvent<DisbursedEvent.InputTuple, DisbursedEvent.OutputTuple, DisbursedEvent.OutputObject>;
